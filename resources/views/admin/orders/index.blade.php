              ...
              <div class="card body">
               ...
               @foreach($orders as $order)
                 <tr>
                   ...
                   <td>
                      <p>
                          @if($order->is_seenByAdmin)
                         <button type="button" class="btn btn-success btn-sm"> Seen</button>
                         @else
                          <button type="button" class="btn btn-warning btn-sm">Not seen</button>
                       @endif
                       </p>
                   ...
                   <td> 
                     <a href="{{ route('admin.orders.show' , $order->id) }}" class="btn btn-info">Show Order</a>

                     <form class="form-inline" action="{{ route('admin.orders.delete' , $order->id) }}" method="post">
                       @csrf
