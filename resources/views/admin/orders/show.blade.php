                ...
                <h3>Order Info</h3>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <p><strong>Order Name :</strong>{{ $order->phone_number }}</p>
                      <p><strong>Order Adress :</strong>{{ $order->delivery_address }}</p>
                      
                    </div>

                     <div class="col-md-6">
                      <p><strong>Order Payment :</strong>{{ $order->payment->name }}</p>
                      <p><strong>transection :</strong>{{ $order->transection_id }}</p>
                    </div>

                  </div>

                  <form action="{{ route('admin.orders.completed' , $order->id) }}" method="post" class="form-inline">
                    @csrf
