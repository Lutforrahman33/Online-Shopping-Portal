                   ...
                   <form action="{{ route('admin.category.update' , $category->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="{{ $category->name }}" id="email">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="parent_id">
                          <option value="">Select a primary Catagory</option>
                      ...
                      <div class="form-group">
                        <label for="image">Image:</label>
                               ...
                               <input type="File" class="form-control" name="image" multiple="multiple" id="image">
